...
/* OTAA para*/
uint8_t devEui[] = { 0x00, 0x31, 0xBC, 0xDD, 0x82, 0x50, 0xC9, 0x3D };
uint8_t appEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0x25, 0x0A };
uint8_t appKey[] = { 0x28, 0xF4, 0xAA, 0xEE, 0xC7, 0x2C, 0x38, 0x0E, 0xAA, 0x5D, 0x20, 0x24, 0x20, 0x83, 0x8F, 0x10 };
